...
<head>
    ...
    <title>CobraGO -- Guidance Office</title>
    <style>
        body {
...
<body>
    <div class="sidebar">
        ...
        <a href="./guidance_dashboard.php">Dashboard</a>
        <a href="./guidance_requests.php">Request Approval</a>
        <a href="./guidance_flag_requests.php">Flagged Requests</a>
        <a href="./guidance_logout.html"><span>Logout</span></a>
    </div>
    ...
    <div class="content">
        ...
        <?php if ($userInfo) : ?>
            <p>Hello, <?= htmlspecialchars($userInfo['go_id']) ?> -- <?= htmlspecialchars($userInfo['go_firstname'] . ' ' . $userInfo['go_lastname']) ?></p>
        <?php else : ?>
            <p>Hello, Guidance Officer</p>
        <?php endif; ?>
...
function getCountStudents($goID) {
    global $con;
...
function getGoInfo() {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        $sql = "SELECT go_id, go_firstname, go_lastname FROM go_account WHERE go_id = ?";
        $stmt = $con->prepare($sql);
