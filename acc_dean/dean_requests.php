...
<body>
    ...
    <center>
        <h1>Request Document Confirmation</h1>
        ...
        $sql = "SELECT * FROM doc_request WHERE (status_id = '4' OR status_id = '5')";
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) == 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td>$charge</td>";
                        echo "<td>$status</td>";
                        echo "<td><button class='edit-button' onclick='updateStatusClear($track_id)'>CONFIRM REQUEST</button>  ||  <button class='edit-button' onclick='updateStatusFlag($track_id)'>FLAG</button></td>";
                        echo "</tr>";
                    }
                }
                ?>
