...
if (isset($_POST["submit"])) {
    ...
    $dean_pass = $_POST['dean_pass'];
    $dean_firstname = $_POST['dean_firstname'];
    $dean_lastname = $_POST['dean_lastname'];
    $dean_email = $_POST['dean_email'];

    // Prepare the SQL statement using prepared statements
    $sql = "INSERT INTO dean_account (dean_id, dean_pass, dean_firstname, dean_lastname, dean_email) 
            VALUES (?, ?, ?, ?, ?)";
    ...
    mysqli_stmt_bind_param($stmt, 'sssss', $dean_id, $dean_pass, $dean_firstname, $dean_lastname, $dean_email);
        ...
        <body>
            <center>
                <div class="form-container">
                    ...
                    <a href="./dean_account.php" class="btn-go-back">Go Back to Dean Account Page</a>
                    <a href="./dean_account_add_form.html" class="btn-add-new">Add Another Account</a>
                </div>
            </center>
        </body>
        </html>
