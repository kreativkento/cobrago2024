...
<body>
    <div class="container">
        <h1><a href="./sl_account.php">EDIT STUDENT LIFE USER ACCOUNT</a></h1>
        ...
        if(isset($_GET['sl_id'])) {
            ...
            while ($row = mysqli_fetch_array($result)) {
                $id = $row['sl_id'];
                $pass = $row['sl_pass'];
                $last = $row['sl_firstname'];
                $first = $row['sl_lastname'];
                $email = $row['sl_email'];
            }
        }
        ?>

        <form method="post" action="./sl_account_edit_process.php?id=<?php echo $id; ?>">
            <table>
