...
<div class="sidebar">
    ...
    <center>
        <h1>GUIDANCE OFFICE USERS</h1>
        <button class="add-account-button"><a href="./guidance_account_add_form.html">Add Account</button></a>
        ...
        $sql = "SELECT * FROM guidance_account";

        $txtsearch = '';
        if (isset($_POST['btnsearch'])) {
            $txtsearch = $_POST['txtsearch'];
            $sql .= "WHERE go_id LIKE '%$txtsearch%' OR 
                    go_firstname LIKE '%$txtsearch%' OR 
                    go_lastname LIKE '%$txtsearch%' OR 
                    go_email LIKE '%$txtsearch%'";
        } else {
            $sql .= "";
        }

        $sql .= " ORDER BY go_id, go_pass, go_firstname, go_lastname, go_email";
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) == 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td>$go_id</td>";
                        echo "<td>$go_pass</td>";
                        echo "<td>$go_firstname</td>";
                        echo "<td>$go_lastname</td>";
                        echo "<td>$go_email</td>";
                        echo "<td><a class='edit-button' href='guidance_account_edit_form.php?go_id=$go_id'>EDIT</a> | 
                             <a class='delete-button' href='guidance_account_delete_confirmation.php?go_id=$go_id'>DELETE</a></td>";
                        echo "</tr>";
                    }
                }
                ?>
