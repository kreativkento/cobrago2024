...
<body>
    ...
    <center>
        ...
        <button class="add-account-button"><a href="./admin_account_add_form.html">Add Account</button></a>
        ...
        if (isset($_POST['btnsearch'])) {
            ...
            $sql .= " WHERE admin_id LIKE '%$txtsearch%' OR 
                    admin_firstname LIKE '%$txtsearch%' OR 
                    admin_lastname LIKE '%$txtsearch%' OR 
                    admin_email LIKE '%$txtsearch%'";
        } else {}

        $sql .= " ORDER BY admin_id, admin_pass, admin_firstname, admin_lastname, admin_email";
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) == 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td><a class='edit-button' href='./admin_account_edit_form.php?admin_id=$admin_id'>EDIT</a> | 
                        <a class='delete-button' href='./admin_account_delete_confirmation.php?admin_id=$admin_id'>DELETE</a></td>";
                        echo "</tr>";
                    }
                }
                ?>
