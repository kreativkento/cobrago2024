...
<body>
    ...
    <center>
        ...
        <button class="add-course-button"><a href="college_course_add_form.php">Add Course</a></button>
        ...
        if (isset($_POST['btnsearch'])) {
            ...
            $sql .= " WHERE course_code like '$txtsearch%' OR course like '$txtsearch%' OR dept_code like '$txtsearch%' ";
        }
        $sql .= " ORDER BY course_code, course, dept_code";
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) == 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td><a href='./college_course_edit_form.php?course_code=$course_code' class='edit-button'>EDIT</a> |
                        <a href='./college_course_delete_confirmation.php?course_code=$course_code' class='delete-button'>DELETE</a></td>";
                        echo "</tr>";
                    }
                }
                ?>
