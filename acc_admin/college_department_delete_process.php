...
if (isset($_GET['dept_code'])) {
    ...
    $sql = "DELETE FROM college_department WHERE dept_code='$id'";
...
<body>
    <center>
        <div class="confirmation-message">
            <h1>College Department Has Been Deleted Successfully</h1>
            <a href="./college_department.php" class="btn-go-back">Go Back to College Department Page</a>
        </div>
    </center>
</body>
</html>
