                ...
                <tbody>
                    ...
                    if (mysqli_num_rows($result) == 0) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>$phone</td>";
                            echo "<td>$email</td>";
                            echo "<td><a class='edit-button' href='./student_account_edit_form_app.php?student_id=$studentid'>EDIT</a> | 
                                <a class='delete-button' href='./student_account_delete_confirmation_app.php?student_id=$studentid'>DELETE</a></td>";
                            echo "</tr>";
                        }
                    }
                    ?>
