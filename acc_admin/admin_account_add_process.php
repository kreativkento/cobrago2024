...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO admin_account (admin_id, admin_pass, admin_firstname, admin_lastname, admin_email) 
            VALUES (?, ?, ?, ?, ?)";
    ...
    mysqli_stmt_bind_param($stmt, 'sssss', $admin_id, $admin_pass, $admin_firstname, $admin_lastname, $admin_email);
        ...
        <body>
            <center>
                <div class="form-container">
                    ...
                    <a href="./admin_account_add_form.html" class="btn-add-new">Add Another Account</a>
                </div>
            </center>
        </body>
        </html>
