...
if (isset($_GET['student_id'])) {
    ...
    $sql = "DELETE FROM student_account WHERE student_id='$id'";

    $result = mysqli_query($con, $sql) or die("Error in deleting the student account...");
...
<body>
    <center>
        <div class="confirmation-message">
            ...
            <a href="./student_account_applications.php" class="btn-go-back">Go Back to Student Account Applications</a>
        </div>
    </center>
</body>
</html>
