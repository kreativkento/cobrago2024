...
<body>
    ...
    if (isset($_GET['student_id']) && !empty($_GET['student_id'])) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<a href='./student_account_delete_process_app.php?student_id=$studentid' class='redirect-button'>Yes</a>";
            echo "<a href='./student_account_applications.php' class='redirect-button'>No</a>";
            echo "</div>";
            echo "</div>";
            echo "</div>";
        } else {
            // No matching records found
            echo "<h1 align='center'><a href='./student_account_applications.php' class='redirect-button'>Go Back</a> &nbsp;&nbsp;&nbsp; Delete Student Information</h1>";
            echo "<div class='container'>";
